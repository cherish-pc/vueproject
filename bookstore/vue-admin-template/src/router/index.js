    ...
    children: [
      {
        path: 'pcUserAdmin',
        name: '系统用户管理',
        component: () => import('@/views/sysAdmin/pcUserAdmin'),
        meta: { title: '系统用户管理', icon: 'userAdmin' }
      },
      {
        path: 'menuAdmin',
        name: '菜单管理',
        component: () => import('@/views/sysAdmin/menuAdmin'),
    ...
    children: [
      {
        ...
        meta: { title: '轮播图管理', icon: 'bannerPic' }
      },
